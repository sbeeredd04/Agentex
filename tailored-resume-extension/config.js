...
const config = {
  ...
  MODELS: {
    ...
    openrouter: [
      { id: 'meta-llama/Meta-Llama-3-8B-Instruct:free', name: 'Llama 3 8B (Free)', tier: 'recommended', description: 'Free model from Meta' },
      { id: 'mistralai/Mistral-7B-Instruct-v0.2:free', name: 'Mistral 7B (Free)', tier: 'budget', description: 'Free model from Mistral' },
      { id: 'openai/gpt-3.5-turbo', name: 'ChatGPT 3.5 Turbo', tier: 'standard', description: 'Fast, classic OpenAI model' },
      { id: 'anthropic/claude-3.5-sonnet', name: 'Claude 3.5 Sonnet (OR)', tier: 'premium', description: 'Anthropic\'s newest model' }
    ]
  },
