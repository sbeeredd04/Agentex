...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks \& Libraries}{: Flask, Django, React, Angular, TensorFlow, PyTorch, scikit-learn, OpenCV, three.js, pandas, numpy, Plotly.js} \\
     \textbf{Tools \& Environments}{: Streamlit, Docker, AWS, Linux, Git, GitHub, Selenium, Google Colab, Jupyter Notebooks} \\
     \textbf{Networking}{: TCP/IP} \\
     \textbf{Web Services}{: REST} \\
